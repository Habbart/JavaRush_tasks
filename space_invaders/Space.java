...
public class Space {
    ...
    public void moveAllItems() {
        List<BaseObject> listOfBaseObjects = getAllItems();
        for(BaseObject o : listOfBaseObjects){
            o.move();
        }
    ...
    public List<BaseObject> getAllItems() {
        List<BaseObject> listOfBaseObjects = new ArrayList<>();
        listOfBaseObjects.addAll(getBombs());
        listOfBaseObjects.addAll(getUfos());
        listOfBaseObjects.addAll(getRockets());
        listOfBaseObjects.add(getShip());
